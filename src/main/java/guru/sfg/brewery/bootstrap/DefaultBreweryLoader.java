...
public class DefaultBreweryLoader implements CommandLineRunner {
    ...
    private void loadSecurityData() {
        ...
        Authority updateOrder = authorityRepository.save(Authority.builder()
                ...
                .build());
        Authority readBOrder = authorityRepository.save(Authority.builder()
        ...
        Authority updateOrderCustomer = authorityRepository.save(Authority.builder()
                ...
                .build());
        Authority readBOrderCustomer = authorityRepository.save(Authority.builder()
        ...
        adminRole.setAuthorities(
                new HashSet<>(Set.of(
                        ...
                        createOrder, readBOrder, updateOrder, deleteOrder
                ))
        );

        customerRole.setAuthorities(
                new HashSet<>(Set.of(
                        readBeer, readCustomer, readBrewery, createOrderCustomer, readBOrderCustomer,
